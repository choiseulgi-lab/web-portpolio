  ...
  sections: [
    {
      id: 'why-design',
      title: 'Why Design',
      content: '사용자가 정보를 쉽고 편안하게 이해할 수 있는 화면에 흥미를 느껴 UI/UX 디자인을 시작했습니다. 피그마로 다양한 서비스를 기획하고 설계하며, 사용자 관점에서 더 쉽고 직관적인 경험을 만드는 방법을 고민해왔습니다. 보기 좋은 화면이 아니라, 문제를 해결하는 디자인을 만드는 것이 제 목표입니다.',
    },
    {
      id: 'how-i-design',
      title: 'How I Design',
      content: '모든 디자인에는 명확한 이유가 있어야 한다고 생각합니다. 정보의 우선순위를 분명히 전달하고, 사용자가 자연스럽게 흐름을 따라갈 수 있는 설계를 추구합니다. 작은 간격과 정렬, 터치 영역 하나에도 근거를 두는 디테일을 만들어가고 싶습니다.',
    },
    {
      id: 'how-i-learn',
      title: 'How I Learn',
      content: '새로운 웹사이트를 탐색하는 것을 좋아합니다. 좋은 서비스를 발견하면 단순히 사용하는 데 그치지 않고, 화면 구성과 사용자 흐름을 살펴보며 설계 의도를 분석합니다. 인상 깊은 디자인은 직접 피그마로 구현해 보며 구조와 원리를 이해하고, 이를 통해 실무 감각과 디자인 역량을 꾸준히 키워가고 있습니다.',
    },
  ],
}
